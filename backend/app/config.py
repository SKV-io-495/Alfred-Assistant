...
class Config:
    ...
    # API Keys
    GROQ_API_KEY: str = os.getenv("GROQ_API_KEY", "")
    HF_API_KEY: str = os.getenv("HF_API_KEY", "")  # Added Hugging Face API Key
    NEWSAPI_KEY: Optional[str] = os.getenv("NEWSAPI_KEY")
    LANGSMITH_API_KEY: Optional[str] = os.getenv("LANGSMITH_API_KEY")
    ...
    REDDIT_CLIENT_SECRET: Optional[str] = os.getenv("REDDIT_CLIENT_SECRET")
    REDDIT_USER_AGENT: str = os.getenv("REDDIT_USER_AGENT", "yeest.xyz/1.0")
    REDDIT_USERNAME: Optional[str] = os.getenv("REDDIT_USERNAME") # Fixed a typo here (was str =)
    REDDIT_PASSWORD: Optional[str] = os.getenv("REDDIT_PASSWORD") # Fixed a typo here (was =)
